...
<head>
	<meta charset="UTF-8"/>
	<title>Castro de Fornecedores</title>
...
<body>
	...
	<form>
		...
		Razao social <input type="text" id=""/><br/>
		CNPJ <input type="text" id=""/><br/>
		CEP <input type="text" id="" /><br/>
		Logradouro <input type="text" id=""/>
		Nº <input type="number" id=""/>
		Complemento <input type="text" id=""/><br/>
		Estado <input type="text" id=""/>
		Cidade <input type="text" id=""/>
		Contato <input type="text" id=""/>
